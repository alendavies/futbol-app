    ...
    return (
        <div className="flex flex-col items-center w-full">
            <div className="flex flex-row space-x-2 items-center mb-5">
                <img src="images\premier.png" className="max-w-4 max-h-5" />
            ...
            <div className="flex w-full justify-around items-center">
                <div className="w-1/2 flex-grow flex flex-row justify-start items-center">
                    <img src="images\tottenham.png" className="drop-shadow-lg absolute max-w-24 max-h-24" />
                ...
                <div className="w-1/2 flex-grow flex flex-row justify-end items-center">
                    ...
                    <img src="images\fulham.png" className="drop-shadow-lg absolute max-w-24 max-h-24" />
                </div>
            </div>
